...
write.table(myobj, file="datasets/data.frame.raw.cov5.tsv", sep='\t', quote=FALSE)
...
write.table(perc.meth, file="dataframe/data.frame.tile500bp.percent.tsv", sep='\t', quote=FALSE)
...
write.table(myDiff, file="diff_meth/AnalyisDiff.tsv", sep='\t', quote=FALSE)

message("myDiff done")
my.diffMeth3.trimmed = getMethylDiff(myDiff,difference=5,qvalue=0.05)
